			...
			<div className="topic">
				...
				<div className="row-right">
					...
					<div className="topic-meta">
						<p>By: <span className="author">{ topic.author } </span></p>
						<p>Status: <span className="author">Veteran</span></p>
						<p>Posts: <span className="author">{ 10 } </span></p>
						<p>Member Since: <span className="date">{ topic.date }</span></p>
					</div>
				</div>
